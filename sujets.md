...
Un article publié = la case cochée, avec la date et le slug. La routine prend toujours le
PREMIER sujet non coché qui contient « PRIORITÉ » (dans l'ordre du fichier), sinon le premier
sujet non coché. Pour ajouter un sujet : une ligne, même format. Pour en écarter un : écrire
« ÉCARTÉ » dans la ligne, avec la raison.
...
suivants : le dentiste y lit la question qu'il se pose au moment de décider d'investir. Les
...
- [x] Marketing dentaire : ce que le code autorise, et les cinq leviers qui amènent des patients | marketing dentaire | Google et Bing complètent « marketing dentaire » (19/09) ; les premiers résultats sont québécois ou généralistes : donner la version française, cadre de l'Ordre compris, sans jamais viser « agence » (page d'offre) | PRIORITÉ 5 (publié le 2026-09-21, marketing-dentaire-ce-que-le-code-autorise)
...
- [ ] ÉCARTÉ (doublon de la page d'offre /fiche-google-dentiste/) · Fiche Google d'un cabinet dentaire : la liste complète de ce qu'il faut remplir | fiche google cabinet dentaire | champ par champ
- [ ] ÉCARTÉ (doublon du guide /guides/doctolib-devant-mon-site/) · Doctolib et référencement : ce que Doctolib fait pour vous, et ce qu'il ne fera pas | doctolib référencement dentiste | rôle de chaque outil
...
- [ ] ÉCARTÉ (doublon du guide /guides/apercus-ia-google-dentiste/) · Aperçus IA de Google : ce qui change quand un patient cherche un dentiste | aperçus ia google dentiste | ce qui s'affiche, ce qui est cité
...
- [ ] ÉCARTÉ (doublon de l'article « comment les IA lisent un site de dentiste ») · Cloudflare, robots.txt et robots des IA : le réglage qui rend un cabinet invisible | robots.txt ia cabinet dentaire | vérifier en deux minutes
- [ ] ÉCARTÉ (doublon de la page /referencement-ia-dentiste/ et du guide /guides/comment-les-ia-choisissent-un-dentiste/) · Perplexity, Gemini, ChatGPT : trois façons différentes de recommander un dentiste | ia recommander dentiste | ce que chacune lit
...
- [ ] ÉCARTÉ (doublon du guide /guides/doctolib-devant-mon-site/) · Recherche de votre nom : pourquoi Doctolib passe devant, et comment reprendre la première place | nom dentiste doctolib avant site | la mécanique, la correction
...
- [ ] Les photos du cabinet : ce qui est utile, ce qui est interdit | photos site cabinet dentaire | locaux, équipe, matériel ; les avant/après ont leur propre article
...
- [ ] ÉCARTÉ (fusionné avec « Orthodontie et aligneurs », partie F) · Orthodontie de l'adulte : les mots que tapent les patients | orthodontie adulte référencement | aligneurs, invisible, prix, durée
...
- [ ] ÉCARTÉ (doublon de « Search Console pour un cabinet dentaire », partie E) · La Search Console en dix minutes par mois : le mode d'emploi du praticien | search console dentiste mode d'emploi | quoi regarder, quoi ignorer
